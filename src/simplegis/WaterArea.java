...
/**
 * WaterArea class for handling map objects of type WaterAreas (lakes).
 * Copyright: Copyright (c) 2002
 * 
 * @author Stefan Friese
 * @version 1.1
 */
public class WaterArea implements IMapObject
{

  public WaterArea(int num)
  {
  ...
  public String toString()
    {
      String answer ="Water Area ID="+this.getId()+"\n";
      for(int i =0; i< coords.length ;i++)
      {
        answer = answer +"Coord"+(i+1)+ " x="+ this.getCoords(i).getX()+" y="+
        this.getCoords(i).getY() +" \n";
      }
  ...
  canvas.fillPolygon(xVal, yVal, this.getCoords().length);
	...
	public void setLineColor(int R, int G, int B) {
		try {
			...
			System.err.println("WaterArea: Color parameters out of range (0-155): R=" + R + ", G=" + G + ", B=" + B);
		}
	}
